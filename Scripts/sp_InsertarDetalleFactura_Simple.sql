-- =============================================
-- Stored Procedure SIMPLE y FUNCIONAL: sp_InsertarDetalleFactura
...
BEGIN
    ...
    BEGIN TRY
        ...
        IF @@ROWCOUNT = 0
        BEGIN
            -- Leer el stock actual para el mensaje
...
PRINT 'Stored Procedure sp_InsertarDetalleFactura creado correctamente (versión simplificada).';
GO
